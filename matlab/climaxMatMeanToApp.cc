...
void meanToApp(const mxArray* prhs[], mxArray** ra, mxArray** dec);
...
void meanToApp(const mxArray* prhs[], mxArray** ra, mxArray** dec)
{
  ...
  std::cout << "meanRa is:  " << meanRa << std::endl;
  std::cout << "meanDec is: " << meanDec << std::endl;

  gcp::util::Astrometry::meanToApparentPlace(meanRa, meanDec, obsMjd, 2000.0, obsRa, obsDec);

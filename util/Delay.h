#ifndef GCP_UTIL_DELAY_H
#define GCP_UTIL_DELAY_H
...
namespace gcp {
  namespace util {
	...
	nanoSeconds_ = delayInNanoSec;
       ...
       */
      void setDelayInSeconds(double delayInSec) {
	nanoSeconds_ = delayInSec * nanoSecPerSec_;
      }
	...
	return nanoSeconds_ / nanoSecPerSec_ * Constants::lightSpeed_.metersPerSec();
      }

      /**
       * Get the delay, in centimeters
       */
      inline double cm() {
	return nanoSeconds_ / nanoSecPerSec_ * Constants::lightSpeed_.centimetersPerSec();
      }
	...
	return dNanoSeconds_ / nanoSecPerSec_ * Constants::lightSpeed_.metersPerSec();
      }
...
#endif // End #ifndef GCP_UTIL_DELAY_H

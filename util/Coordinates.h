#ifndef GCP_UTIL_COORDINATES_H
#define GCP_UTIL_COORDINATES_H
...
namespace gcp {
  namespace util {
	...
	return altitude_;
       ...
       */
      Vector<double> getUvw(HourAngle ha, Declination declination);
	...
	lngLatAndAzElToLngLat(Angle& lng,       Angle& lat,
       ...
       */
      static Vector<double> haDecAndXyzToUvw(HourAngle ha, Declination declination,
       ...
       *                   direction only.
       */
      static Vector<double> haDecToXyz(HourAngle ha, Declination declination,
				       bool geocentric=true, 
	...
	laAndHaDecToAzEl(Angle latitude, double altitude,
       ...
       */
      static Delay getGeometricDelay(HourAngle ha, Declination declination,
				     double X, double Y, double Z,
       ...
       */
      static Vector<double> getdUvw(HourAngle ha, Declination declination, 
				    double X, double Y, double Z);
      
      /**
       * Second derivatives of the UVW coordinates wrt time. (X/s^2)
       */
      static Vector<double> getd2Uvw(HourAngle ha, Declination declination, 
				     double X, double Y, double Z);
      /**
       * Allows cout << coords
       */
    ...
    private:
      ...
      static const unsigned secondsPerDay_;
       ...
       */
      static Matrix<double> getXyzToUvwDecRot(Declination declination);
...
#endif // End #ifndef GCP_UTIL_COORDINATES_H

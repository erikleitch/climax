...
const unsigned Coordinates::secondsPerDay_ = 86400;
 ...
 *   altitude  (m)
 */
Vector<double> Coordinates::getUvw(HourAngle ha, Declination declination)
{
 ...
 * E, U) and (X, Y, Z)
 */
gcp::util::Matrix<double> Coordinates::getUenToXyzLonRot(Angle longitude)
{
  gcp::util::Matrix<double> lonRot(3,3);
 ...
 */
gcp::util::Matrix<double> Coordinates::getUenToXyzLatRot(Angle latitude)
{
 ...
 *   altitude  (m)
 */
Vector<double> Coordinates::haDecAndXyzToUvw(HourAngle ha, Declination declination,
 ...
 * coordinate.
 */
Vector<double> Coordinates::haDecToXyz(HourAngle ha, Declination declination,
			      ...
			      SrcDist type, double r)
{
  ...
  Vector<double> topoXyzSrcDir = (geoXyzSrcDir - (geoXyzObsDir * (double)fac));
 ...
 *   altitude  (m)
 */
Vector<double> Coordinates::getdUvw(HourAngle ha, Declination declination, 
				    double X, double Y, double Z)
{
  Vector<double> xyzVals(3);
 ...
 *   altitude  (m)
 */
Vector<double> Coordinates::getd2Uvw(HourAngle ha, Declination declination, 
				     double X, double Y, double Z)
{
  Vector<double> xyzVals(3);
 ...
 * baseline endpoint.
 */
Delay Coordinates::getGeometricDelay(HourAngle ha, Declination declination, 
				     double X, double Y, double Z,
 ...
 */
ostream& 
gcp::util::operator<<(ostream& os, Coordinates& coords)
{
  os << coords.longitude() << " ";
  os << coords.latitude()  << " ";
 ...
 * and UVW
 */
gcp::util::Matrix<double> Coordinates::getXyzToUvwDecRot(Declination declination)
{
 ...
 */
gcp::util::Matrix<double> Coordinates::getXyzToUvwHaRot(HourAngle ha)
{
 ...
 */
gcp::util::Matrix<double> Coordinates::getdXyzToUvwHaRot(HourAngle ha)
{
  gcp::util::Matrix<double> haRot(3,3), result;
  ...
  result = haRot * (2*M_PI/secondsPerDay_);
 ...
 * transforming between XYZ and UVW
 */
gcp::util::Matrix<double> Coordinates::getd2XyzToUvwHaRot(HourAngle ha)
{
  gcp::util::Matrix<double> haRot(3,3), result;
  ...
  result = haRot * (2*M_PI/secondsPerDay_)*(2*M_PI/secondsPerDay_);

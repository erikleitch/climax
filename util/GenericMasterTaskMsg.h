  ...
  namespace util {
				      ...
				      SIGNALTASK_HANDLER_FN(*handler)) 
	{
	  genericMsgType_ = (GenericTaskMsg::GenericMsgType)
	    gcp::util::GenericMasterTaskMsg::INSTALL_TIMER;
	...
	{
	  genericMsgType_ = (GenericTaskMsg::GenericMsgType)
	    gcp::util::GenericMasterTaskMsg::INSTALL_SIGNAL;
	...
	{
	  genericMsgType_ = (GenericTaskMsg::GenericMsgType)
	    gcp::util::GenericMasterTaskMsg::ENABLE_TIMER;
	...
	{
	  genericMsgType_ = (GenericTaskMsg::GenericMsgType)
	    gcp::util::GenericMasterTaskMsg::ADD_HANDLER;

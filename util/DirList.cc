 ...
 * Output Operator.
 */
std::ostream& gcp::util::operator<<(std::ostream& os, DirList& obj)
{
			  ...
			  bool descend)
{
  ...
  if(!dir) {
    ThrowSysError("opendir(): Unable to list " << path);
    return;
  }
...
std::ostream& gcp::util::operator<<(std::ostream& os, DirList::DirEnt& entry)
{

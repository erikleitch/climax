...
namespace gcp {
  namespace util {
    ...
    class SignalTask :
      public gcp::util::
      GenericTask<gcp::util::SignalTaskMsg> {
	...
	AbsTimer* timer_;            // The timer itself
      };
	 ...
	 * Constructors.
	 */
	SignalHandler(int sigNo, SIGNALTASK_HANDLER_FN(*handler), 
		      void* arg=NULL);
	...
	TimerInfo* timer_;
       ...
       */
      void addHandler(std::string name, SIGNALTASK_HANDLER_FN(*handler), 
		      void* args=NULL);
       ...
       */
      void installSignal(int sigNo, SIGNALTASK_HANDLER_FN(*handler), 
			 void* arg=NULL);
      
      /**
       * Add a handler to the set of handlers for the named timer.
       */
      void addHandler(int sigNo, SIGNALTASK_HANDLER_FN(*handler), 
		      void* args=NULL);

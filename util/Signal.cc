#define __FILEPATH__ "util/common/Signal.cc"
...
void Signal::setUpSigAction()
{
  ...
  if(userhandler_ != 0 || useraction_ != 0) {
    ...
    if(sigaction(sigNo_, &sat, NULL) != 0)
      ThrowSysError("Signal::Signal: Error in sigaction().\n");
  }
}

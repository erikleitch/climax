 ...
 */
void Astrometry::apparentToMeanPlace(HourAngle& apparentRa, Declination& apparentDec, TimeVal& date, 
				     double equinox,
 ...
 * Convert from apparent place to mean place
 */
void Astrometry::apparentToJ2000Place(HourAngle& apparentRa, Declination& apparentDec, TimeVal& date, 
				      HourAngle& meanRa, Declination& meanDec)
{
 ...
 */
void Astrometry::meanToApparentPlace(HourAngle& meanRa, Declination& meanDec, TimeVal& date, 
				     double equinox,
 ...
 */ 
void Astrometry::j2000ToApparentPlace(HourAngle& meanRa, Declination& meanDec, TimeVal& date, 
				      HourAngle& apparentRa, Declination& apparentDec)
{
  meanToApparentPlace(meanRa, meanDec, date, 2000.0, apparentRa, apparentDec);
}

void Astrometry::b1950ToJ2000(HourAngle& raB1950, Declination& decB1950, HourAngle& raJ2000, Declination& decJ2000)
{
...
void Astrometry::j2000ToB1950(HourAngle& raJ2000, Declination& decJ2000, HourAngle& raB1950, Declination& decB1950)
{
...
Angle Astrometry::angularSeparation(HourAngle ra1, Declination dec1, HourAngle ra2, Declination dec2)
{
  Angle sep;
...
/**.......................................................................
 * Return X-Y separations for flat-sky approximation:
 */
void Astrometry::flatSkyApproximationSeparations(Angle& xSep, Angle& ySep,
						 HourAngle& ra1, Declination& dec1,
						 HourAngle& ra2, Declination& dec2)
{
  double deltaRARadians  = ra1.radians()  - ra2.radians();
  double deltaDecRadians = dec1.radians() - dec2.radians();

  xSep.setRadians(deltaRARadians * cos(dec1.radians()));
  ySep.setRadians(deltaDecRadians);
}

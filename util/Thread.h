#ifndef GCP_UTIL_THREAD_H
#define GCP_UTIL_THREAD_H
...
namespace gcp {
  namespace util {
    ...
    public:
       ...
       *
       * @param startOrder The order in which to start this thread
       *
       * @param stopOrder The order in which to stop this thread 
       *
       * @param schedPolicy The Scheduling policy for this thread
       *
       */
      Thread(THREAD_START(*startFn), 
      ...
      // Note that if you use this constructor, you will have to
      // specify the start and stop order
	...
	return name_;
      ...
      // Set the affinity of this thread -- now supported on certain
      // platforms (like Mac OS X, which doesn't export control
      // interfaces to scheduling affinities).  If you don't know what
      // this does, DO NOT try to use it.

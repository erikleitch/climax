...
#ifndef GCP_UTIL_CARMACONFIG_H
#define GCP_UTIL_CARMACONFIG_H
...
namespace gcp {
  namespace util {
	...
	gcp::util::Length diameter_;
	gcp::util::Length sweptVolumeDiameter_;
	gcp::util::Length elAxisHeight_;
	gcp::util::Length cylinderDiameter_;
	...
	gcp::util::Antenna::AntennaType getAntType();
	...
	unsigned padNumber_;// The CARMA pad number (NB: these are NOT
			    // consecutive!)
	gcp::util::Length east_;  // The east location of this pad
				  // (relative to pad 32)
	gcp::util::Length north_; // The north location of this pad
				  // (relative to pad 32)
	gcp::util::Length up_;    // The vertical location of this pad
				  // (relative to pad 32)
...
#endif // End #ifndef GCP_UTIL_CARMACONFIG_H

 ...
 */
ostream& 
gcp::util::operator<<(ostream& os, CarmaConfig::PadLocation& pad)
{
 ...
 */
ostream& 
gcp::util::operator<<(ostream& os, CarmaConfig::Antenna& ant)
{
 ...
 */
gcp::util::Antenna::AntennaType CarmaConfig::Antenna::getAntType()
{
  if(antFlag_ & OVRO) {
    return gcp::util::Antenna::ANT_OVRO;
  } else if(antFlag_ & BIMA) {
    return gcp::util::Antenna::ANT_BIMA;
  } else if(antFlag_ & SZA) {
    return gcp::util::Antenna::ANT_SZA;
  } else {
    return gcp::util::Antenna::ANT_UNKNOWN;
  }
}
